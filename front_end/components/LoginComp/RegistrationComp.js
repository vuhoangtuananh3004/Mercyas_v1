        ...
        <View classname="flex justify-center">
            <View className="flex-row justify-start gap-5">
                <View className="flex flex-col">
                    ...
                    <TextInput  className="h-[60px] w-[160px] rounded-l-lg rounded-r-lg border-2 border-black shadow-xl shadow-black drop-shadow-xl"/>
                </View>
                <View className="flex flex-col justify-start">
                    <Text>Last Name</Text>
                    <TextInput placeholder="Thinh" className="h-[30px] w-[120px] justify-center items-center rounded-l-lg rounded-r-lg border-2 border-black shadow-xl shadow-black drop-shadow-xl"/>
                </View>
            </View>
            <View className="flex-row justify-start gap-5">
                <View className="flex flex-col justify-start">
                    <Text>Address</Text>
                    <TextInput placeholder="Address" className="h-[30px] w-[260px] justify-center items-center rounded-l-lg rounded-r-lg border-2 border-black shadow-xl shadow-black drop-shadow-xl"/>
                </View>
            </View>
